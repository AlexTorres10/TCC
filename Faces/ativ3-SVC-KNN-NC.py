...
accSVC = rightSVC/len(pred_svc)*100
print("Tive",right,"acertos e",wrong,"erros com",acc,"% de acurácia")
print("Só com o SVC, tive",rightSVC,"acertos e",wrongSVC,"erros com",accSVC,"% de acurácia")
print("Acurácia do KNN:",accuracy_score(t_y, pred_knn))
print("Acurácia do NC:",accuracy_score(t_y, pred_nc))